    ...
    <div className="max-w-md mx-auto md:max-w-4xl pb-24 md:pb-0 font-sans px-4 min-h-screen">
      ...
      <div className="mb-6">
        ...
        >
          ...
          <div className="mt-6 bg-white rounded-2xl p-4 flex items-center gap-3 shadow-sm group-hover:bg-blue-50 transition-colors">
            ...
            <span className="text-gray-400 text-sm font-medium group-hover:text-blue-600">
              Bạn muốn đi đâu?
            </span>
          </div>
        </Link>
        ...
        <div className="mb-8 animate-fade-in-down">
          ...
          >
            ...
            <div className="flex justify-between items-start mb-3 pl-3">
              <span
                className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded bg-blue-50 text-blue-600`}
              >
            ...
            <div className="flex items-center gap-4 pl-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-gray-500 truncate">
                  {activeTrip.tripInfo?.vehicleId
                    ? `Xe: ${activeTrip.tripInfo.vehicleId}`
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <Link
          ...
          className="bg-white p-5 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-lg hover:border-purple-100 transition-all active:scale-95 flex flex-col justify-between h-40 group"
        >
          <div className="w-12 h-12 bg-purple-50 rounded-2xl flex items-center justify-center text-2xl group-hover:bg-purple-100 transition-colors">
            📜
          </div>
          <div>
            <h3 className="font-bold text-gray-800 text-lg">Lịch sử</h3>
        ...
        <Link
          to="/passenger/profile"
          className="bg-white p-5 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-lg hover:border-orange-100 transition-all active:scale-95 flex flex-col justify-between h-40 group"
        >
          <div className="w-12 h-12 bg-orange-50 rounded-2xl flex items-center justify-center text-2xl group-hover:bg-orange-100 transition-colors">
            👤
          </div>
          <div>
            <h3 className="font-bold text-gray-800 text-lg">Tài khoản</h3>
            <p className="text-xs text-gray-400 mt-1 font-medium">
              Cài đặt & Ví
            </p>
          </div>
      ...
      <div className="bg-gray-50/50 rounded-[24px] p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            to="/passenger/history"
            className="text-xs text-blue-600 font-bold hover:bg-blue-50 px-2 py-1 rounded-lg transition-colors"
          >
            Xem tất cả
          </Link>
        </div>
        ...
        {lastTrip ? (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="font-bold text-gray-800 truncate text-sm mb-0.5">
                {lastTrip.dropoffLocation}
              </p>
              <p className="text-xs text-gray-400 flex items-center gap-1">
                {lastTrip.timeSlot
                  ? new Date(lastTrip.timeSlot).toLocaleString("vi-VN")
                  : ""}
              </p>
            </div>
            {/* ĐÃ BỎ GIÁ */}
