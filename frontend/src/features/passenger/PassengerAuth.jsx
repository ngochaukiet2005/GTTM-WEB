...
const PassengerAuth = () => {
    ...
    try {
      ...
      const { value: otpCode } = await Swal.fire({
        ...
        customClass: {
          ...
          confirmButton:
            "bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-lg text-base shadow-md w-full sm:w-auto mt-3",
          cancelButton:
            "bg-gray-100 hover:bg-gray-200 text-gray-600 font-semibold py-2.5 px-4 rounded-lg text-base mt-3",
        ...
        preConfirm: async (otp) => {
          try {
            await apiClient.verifyEmail({ email: formData.email, otp });
            return true;
          } catch (error) {
      ...
      if (otpCode) {
        ...
        // Đăng nhập tự động sau khi verify
        ...
        await Swal.fire({
          icon: "success",
          title: "Thành công!",
          text: "Tài khoản đã kích hoạt và đăng nhập.",
          timer: 1500,
          width: "320px",
          showConfirmButton: false,
          customClass: {
  ...
  return (
    <AuthLayout
      ...
      subtitle={
        isRegister
          ? "Trải nghiệm đặt xe dễ dàng, nhanh chóng."
          : "Đăng nhập để đặt chuyến xe tiếp theo."
      }
      bgColor="bg-blue-600"
